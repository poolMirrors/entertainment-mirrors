...
(
	...
	message_type VARCHAR(32) NOT NULL COMMENT '消息类型代码：blog',
	...
	returnsuccess_date DATETIME NULL COMMENT'回复成功内容',
	returnfailure_msg VARCHAR(2048) NULL COMMENT '回复失败内容',
	execute_date DATETIME NULL COMMENT '最近通知时间',
	stage_statel CHAR DEFAULT '0' NOT NULL COMMENT'阶段1处理状态，0：初始，1：成功',
	stage_state2 CHAR DEFAULT '0' NOT NULL COMMENT'阶段2处理状态，θ：初始，1：成功',
	stage_state3 CHAR DEFAULT '0' NOT NULL COMMENT'阶段3处理状态，θ：初始，1：成功',
	stage_state4 CHAR DEFAULT '0' NOT NULL COMMENT'阶段4处理状态，θ：初始，1：成功'
